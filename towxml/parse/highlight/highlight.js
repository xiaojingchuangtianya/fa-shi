...
const IDENT_RE = "[a-zA-Z]\\w*",
  ...
  NUMBER_MODE = { className: "number", begin: NUMBER_RE, relevance: 0 },
  C_NUMBER_MODE = { className: "number", begin: C_NUMBER_RE, relevance: 0 },
  BINARY_NUMBER_MODE = {
    className: "number",
    begin: "\\b(0b[01]+)",
    relevance: 0,
  ...
  TITLE_MODE = { className: "title", begin: IDENT_RE, relevance: 0 },
...
function compileLanguage(e) {
  ...
  !(function t(i, s) {
    i.compiled ||
      ...
      i.keywords &&
        (i.keywords = compileKeywords(i.keywords, e.case_insensitive)),
  ...
  return (
    e.variants &&
      ...
      (e.cached_variants = e.variants.map(function (n) {
        return inherit(e, { variants: null }, n);
      })),
    e.cached_variants
      ? e.cached_variants
...
const escape$1 = escapeHTML,
  inherit$1 = inherit,
  { nodeStream: nodeStream$1, mergeStreams: mergeStreams$1 } = utils,
  HLJS = function (e) {
    var n = [],
      t = {},
      r = {},
    ...
    function d(e, n, r, a) {
      ...
      function E(e) {
        ...
        if (r) {
          ...
          a.skip
            ? (S += n)
            : (a.returnEnd || a.excludeEnd || (S += n),
              u(),
              a.excludeEnd && (S = n));
          do {
            b.className && N.closeNode(),
      ...
      function m(n, t) {
        ...
        if (
          ...
          if (((S += s.slice(t.index, t.index + 1)), !i))
            throw (
              (((a = new Error("0 width match regex")).languageName = e),
              (a.badRule = _.rule),
              a)
            );
          return 1;
      ...
      try {
        ...
        for (
          ...
          w ? (w = !1) : ((b.matcher.lastIndex = D), b.matcher.considerAll()),
            (O = b.matcher.exec(s));
    ...
    function g(e, n) {
      ...
      var r = { relevance: 0, emitter: new l.__emitter(l), value: escape$1(e) },
        a = r;
      return (
        n
          .filter(p)
    ...
    function f(e) {
      var n,
        ...
        d = (function (e) {
          ...
          if (
            ...
            (n = l.languageDetectRe.exec(t)))
          ) {
            var r = p(n[1]);
            return (
              r ||
                (console.warn(o.replace("{}", n[1])),
                console.warn(
      ...
      c(d) ||
        ...
        (t = nodeStream$1(n)).length &&
          ...
          (a.value = mergeStreams$1(t, nodeStream$1(i), s))),
        (a.value = h(a.value)),
